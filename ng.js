...
(function() {
  ...
  run.$inject = ['eventbus', 'authService', '$rootScope'];

    function run(eventbus, authService, $rootScope) {
...
(function() { 'use strict'; angular.module("templates").run(["$templateCache", function($templateCache) {$templateCache.put("ng/spryhub/home.view/home.html","<div class=\"container-fluid\">\r\n    <div class=\"row\">\r\n        <div class=\"col-md-10 col-md-push-1\">\r\n\r\n\r\n            <h2><em>Make GitHub Agile</em></h2>\r\n\r\n\r\n            <p>The Spry Group is hooked on GitHub. We’re also Agile developers hooked on our own methodology. Problem is, GitHub and Agile don\'t look at projects the same way. So what did we do? We took native GitHub and translated it into an Agile project management tool.</p>\r\n\r\n            <h3><em>Bridge the Gap</em></h3>\r\n\r\n            <p>SpryHub transforms GitHub milestones and labels into a view of sprints and project velocity. Product Owners, Project Managers and Lead Developers get a quick view of comparative sprint metrics. Once it has logged three completed sprints, SpryHub provides an estimated timeframe for project completion. This saves time and helps Agile teams to more effectively manage projects and communicate clearly with clients.</p>\r\n\r\n            <p> SpryHub bridges the gap between GitHub and Agile development.</p>\r\n\r\n            <h3><em>SpryHub makes GitHub Agile</em></h3>\r\n\r\n\r\n            <p>We hope you\'ll find it as useful as we do. When incorporated into a good workflow, these small pieces of automation have a large impact. The 8-10 hours per week we\'ve been saving frees team members to focus more on continually developing valuable software.</p>\r\n\r\n            <p>We invite you to try SpryHub. Help guide the product and get grandfathered in as we add more advanced features and expand our offering.</p>\r\n\r\n            <h4>\r\n            <a name=\"let-us-know-what-you-want\" href=\"#let-us-know-what-you-want\"></a>Let us know what you want.</h4>\r\n\r\n            <p>We\'d love your feedback and suggestions. Please <a href=\"https://github.com/spry-group/spryhub.io/issues/new\">open an issue</a> and let us know what you want.</p>\r\n\r\n        </div>\r\n    </div>\r\n</div>");
$templateCache.put("ng/spryhub/learn.view/learn.html","<div class=\"container-fluid\">\r\n    <div class=\"row\">\r\n        <div class=\"col-md-10 col-md-push-1\">\r\n\r\n\r\n            <h2><em>Features and Benefits</em></h2>\r\n\r\n            <p>1. Project velocity shows teams the average amount of work completed for each sprint on the project.\r\n            2. Rolling three sprint velocity/shows teams the average velocity of the previous three sprints.\r\n            3. Remaining sprints shows an estimate, based on past performance of how many sprints remain given the project’s current scope.\r\n            </p>\r\n\r\n            <h3><em>How it Works</em></h3>\r\n\r\n            <p> SpryHub relies on the GitHub API to translate project (repo) metrics into a view designed for Agile developers.\r\n\r\n            Label terms - In order to provide these metrics, SpryHub depends our users to follow a specific way of assigning labels to GitHub issues. We provide custom labels which the user will assign to each issue. SpryHub then pulls in the label data and converts it into an Agile perspective.\r\n\r\n            Milestones - After labeling the issues of a specific project/repo, we then assign each issue to a specific milestone. SpryHub then recasts the milestone data as a sprint.\r\n            </p>\r\n\r\n            <h3><em>SpryHub makes GitHub Agile</em></h3>\r\n\r\n        </div>\r\n    </div>\r\n</div>");
...
(function() {
    ...
    HomeController.$inject = ['eventbus', '$state'];

    function HomeController(eventbus, $state) {
        var vm = this;
...
(function() {
    ...
    function ProjectsController(eventbus, authService, repoService, $state, $stateParams, githubService, labelsService) {
        var vm = this;
  ...
  function RepoService(github, $q, issueService, sprintService, backlogService) {
    ...
    function Repository(repo) {
      ...
      function _calculateMetrics() {
        ...
        _repo.confidence = Math.round((1 - (backlog.issues_no_points + backlog.issues_no_priority) / 2 / backlog.issues_open) * 100);
      }
